...
<h2> Sumário </h2>
<ol>
<li> Criando e editando meu primeiro repositório; </li>
<li> Baixando um repositório de outro usuário para colaborar; </li>
<li> Baixando o repositório para a sua máquina, editando e enviando de volta para o servidor do GitHub; </li>
<li> Criando um "universo paralelo" para editar sem influenciar no código já escrito. </li>
</ol>
...
## Criando um "universo paralelo" para editar sem influenciar no código já escrito.

Passo 1 - Para criar o branch, iremos chamar esse universo de branch a partir de agora, é necessário abir o site no repositório escolhido.

Passo 1.1 - Aberto clicar no quadrado superior esquerdo escrito "main", escreva o nome do branch.

Passo 1.2 - Após escrito ira abrir uma opção "Create branch: [nome_do_branch]", clique nessa opção.

Passo 1.3 - Com isso ira criar um espaço novo no diretório, com a cópia de todos os arquivos da "main".

Passo 2 - Agora abra o Git Bash na pasta do repositório no seu computador.
...
Passo 4 - Sempre que quiser editar um arquivo específico sem alterar o main, ou criar um aquivo sem ter certeza se ira utilizalo volte para qualquer branch e faça o que você precisar sem interferir na principal.

Passo 4.1 - Quando quiser juntar as branch, sim você pode e com isso ira colocar tudo que não tem na principal, abra o site no repositorio.
...
Passo 4.5 - Sim outra confirmação, se ficou verdinho clique em "Merge pull request", se não ficou procure mais a fundo na internet, pois tera que arrumar manualmente, acredito que o seu ficou verdinho, e confirma novamente ou muda a descrição.

Passo 5 - Pronto deu certo, volta para a opção Code, esta na barra superior, agora você consegue ver que o aquivo está na brach main.
